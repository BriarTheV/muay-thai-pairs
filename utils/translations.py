...
translations = {
    "en": {
        ...
        "upload_help": "Spreadsheet file (.xlsx or .ods) must have columns in order: Name, Gender, Age, Weight, Club, Trainer, Record",
    ...
    "ru": {
        ...
        "upload_help": "Файл таблицы (.xlsx или .ods) должен иметь столбцы в порядке: Name, Gender, Age, Weight, Club, Trainer, Record",
