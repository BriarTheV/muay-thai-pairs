...
translations = {
    "en": {
        ...
        "upload_help": "Spreadsheet file (.xlsx or .ods) must contain columns: Name, Gender, Age, Weight, Club, Trainer, Record",
    ...
    "ru": {
        ...
        "upload_help": "Файл таблицы (.xlsx или .ods) должен содержать столбцы: Name, Gender, Age, Weight, Club, Trainer, Record",
