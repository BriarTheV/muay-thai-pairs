...
translations = {
    "en": {
        ...
        "upload_help": "Spreadsheet file (.xlsx or .ods) must have columns in order: Name, Gender, Age, Weight Class, Club, Trainer, Record. Weight Class can be exact number or 'до X' for under X kg. Record is total fights.",
    ...
    "ru": {
        ...
        "upload_help": "Файл таблицы (.xlsx или .ods) должен иметь столбцы в порядке: Name, Gender, Age, Weight Class, Club, Trainer, Record. Weight Class может быть точным числом или 'до X' для до X кг. Record - общее количество боев.",
