...
translations = {
    "en": {
        ...
        "existing_pairs_adjustments": "Adjust Existing Pairs",
        "drag_drop_pairing": "Drag & Drop Pairing",
        "drag_drop_instructions": "Drag fighters from the pool below to create pairs. Valid pairings will be highlighted in green.",
        "unmatched_pool": "Unmatched Fighters Pool",
        "pairing_workspace": "Pairing Workspace",
        "drop_here": "Drop fighter here to start a pair",
        "pair_complete": "Pair complete! Fighters moved to matches.",
        "invalid_pair": "Invalid pairing",
        "gender_mismatch": "Gender mismatch - fighters must be same gender",
        "age_division_mismatch": "Age division mismatch - fighters must be in same age group",
        "weight_diff_too_large": "Weight difference too large for this age division",
        "club_conflict_warning": "Club conflict detected - pairing allowed but not recommended",
        "drag_to_pair": "Drag a fighter here",
        "pairing_success": "✅ Pairing successful!",
        "pairing_error": "❌ Pairing failed:",
        ...
        "no_fighter_data_upload": "No fighter data available. Upload data in the Data Upload tab first.",
    ...
    "ru": {
        ...
        "existing_pairs_adjustments": "Корректировка существующих пар",
        "drag_drop_pairing": "Перетаскивание для пар",
        "drag_drop_instructions": "Перетащите бойцов из пула ниже для создания пар. Допустимые пары будут выделены зеленым.",
        "unmatched_pool": "Пул непарных бойцов",
        "pairing_workspace": "Рабочая область пар",
        "drop_here": "Бросьте бойца сюда для начала пары",
        "pair_complete": "Пара завершена! Бойцы перемещены в матчи.",
        "invalid_pair": "Недопустимая пара",
        "gender_mismatch": "Несоответствие пола - бойцы должны быть одного пола",
        "age_division_mismatch": "Несоответствие возрастной группы - бойцы должны быть в одной возрастной группе",
        "weight_diff_too_large": "Слишком большая разница веса для этой возрастной группы",
        "club_conflict_warning": "Обнаружен конфликт клубов - пары разрешены, но не рекомендуются",
        "drag_to_pair": "Перетащите бойца сюда",
        "pairing_success": "✅ Парные успешны!",
        "pairing_error": "❌ Парные не удались:",
        ...
        "no_fighter_data_upload": "Данные бойцов недоступны. Загрузите данные на вкладке Загрузка данных.",
