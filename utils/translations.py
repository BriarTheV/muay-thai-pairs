...
translations = {
    "en": {
        ...
        "upload_help": "Spreadsheet file (.xlsx or .ods) must have columns in order: Name, Gender, Age, Weight, Club, Trainer, Record. Weight can be exact number or 'до X' for under X kg",
    ...
    "ru": {
        ...
        "upload_help": "Файл таблицы (.xlsx или .ods) должен иметь столбцы в порядке: Name, Gender, Age, Weight, Club, Trainer, Record. Вес может быть точным числом или 'до X' для до X кг",
